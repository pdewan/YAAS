...
public class AnIntegerBarChartVisualizer
		extends ACollectionVisualizer<Integer>
...
//	IntegerBarChartVisualization shapes = new AnIntegerBarChartVisualization();
	...
	public synchronized void visualize(ListenableVector<Integer> data, LayoutManager aLayoutManager)
			/*throws Exception*/ {
...
//	public AnIntegerBarChartLayoutManager getIntegerBarChartLayoutManager() {
//		return (AnIntegerBarChartLayoutManager)  getLayoutManager();
//	}
	
	
//	@Override
//	protected ListenableVector<Integer> createBuffer() {
...
//			VectorMethodsListener<Integer> anObserver) {
...
//	protected void visualizeBuffer(ListenableVector<Integer> vector) {
...
//		
//	}
//	public VisualizationBasedLayoutManager<ListenableVector<Integer>> getLayoutManager() {
//		return (VisualizationBasedLayoutManager<ListenableVector<Integer>>) layoutManager;
//	}
//	public void setLayoutManager (VisualizationBasedLayoutManager<ListenableVector<Integer>> newVal) {
