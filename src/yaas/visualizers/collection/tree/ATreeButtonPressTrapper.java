...
public class ATreeButtonPressTrapper<ContentShapeType> extends AButtonPressTrapper implements
		ButtonPressTrapper {

	
	private ATreeLayoutManager layoutManager;
...
//	private ListenableVector buffer;
	...
	public ATreeButtonPressTrapper(Control controller,
			ATreeVisualizer<ContentShapeType> aVisualizer) {
		super(controller, aVisualizer);
//		layoutManager = (ATreeLayoutManager) aVisualizer.getLayoutManager();
...
//		buffer = (ListenableVector) aVisualizer.getRootBuffer();
	...
	ListenableVector buffer() {
		return (ListenableVector) visualizer.getRootBuffer();
	}
...
//			layoutManager = (ATreeLayoutManager) visualizer
//					.getLayoutManager();
		}
//		if (null == buffer()) {
