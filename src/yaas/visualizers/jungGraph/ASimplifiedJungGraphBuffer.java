...
public class ASimplifiedJungGraphBuffer<V,E> extends ObservableGraph<V, E>
		implements
		GraphEventListener<V, E>,
//		ObservableGraph<V, E>,
		Buffer<GraphEventListener<V, E>, ObservableGraph<V, E>> {
//	,
//}
//		EventTrapper<VectorMethodsListener<ElementType>, ListenableVector<ElementType>> {

	protected Buffer<GraphEventListener<V, E>, ObservableGraph<V,E>> buffer;
	
	ASimplifiedJungGraphVisualizer<V, E> jungGraphVisualizer;
	AJungGraphEventTrapper<Number, Number> trapper;
	
	public ASimplifiedJungGraphBuffer(Graph<V,E> aGraph,
			Visualizer<GraphEventListener<V, E>, ObservableGraph<V,E>> aVisualizer) {
		super(aGraph);
		buffer = new ABuffer<GraphEventListener<V, E>, ObservableGraph<V,E>>(aVisualizer);
		jungGraphVisualizer = (ASimplifiedJungGraphVisualizer<V, E>) aVisualizer;
		
	}

	public ASimplifiedJungGraphBuffer(Graph<V,E> aGraph,
			ObservableGraph<V,E> data,
			VisualizationBasedVisualizer<GraphEventListener<V, E>, ObservableGraph<V,E>> visualizer) {
		super(aGraph);
		buffer = new ABuffer<GraphEventListener<V, E>, ObservableGraph<V,E>>(visualizer);
	...
	public void putBufferThread(
			Visualizer<GraphEventListener<V, E>, ObservableGraph<V, E>> v,
			Control control) {
	...
	public ObservableGraph<V, E> getBufferData() {
...
//	}
	...
	public void addListener(
			EventTrapper<GraphEventListener<V, E>, ObservableGraph<V, E>> observer)
			throws Exception {
