...
public class ACopyElementFromTempCommand<ElementType> implements Command{
	...
	public ACopyElementFromTempCommand(ListenableVector<ElementType> buf, int aToPosition) {
		buffer = buf;
		toPosition = aToPosition;
	}
	public Object execute() {
		oldVal = (ElementType) buffer.get(toPosition);
		buffer.copyFromTemp(toPosition);
		return null;
	}
	public void undo() {
