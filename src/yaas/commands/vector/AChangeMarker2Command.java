...
public class AChangeMarker2Command<ElementType> implements Command{
	...
	public AChangeMarker2Command(ListenableVector<ElementType> buf, int pos) {
		buffer = buf;
		position = pos;
	}
	public Object execute() {
		buffer.setPointer2(position);

		
		return null;
	}
	public void undo() {
		 buffer.setPointer2 (oldVal);
	}
