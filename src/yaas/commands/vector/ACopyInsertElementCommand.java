...
public class ACopyInsertElementCommand<ElementType> implements Command{
	...
	public ACopyInsertElementCommand(ListenableVector<ElementType> buf, int aFromPosition, int pos) {
		buffer = buf;
		toPosition = pos;
	...
	public Object execute() {
		...
		buffer.copyAndInsert(fromPosition, toPosition);
		return null;
	}
	public void undo() {
		buffer.remove(toPosition);
