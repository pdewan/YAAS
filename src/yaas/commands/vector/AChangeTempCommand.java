...
public class AChangeTempCommand<ElementType> implements Command{
	
	
	private ListenableVector<ElementType> buffer;
	private Object newVal, oldVal;
	
	public AChangeTempCommand(ListenableVector<ElementType> buf, Object theObj) {
		buffer = buf;
		newVal = theObj;
	}
