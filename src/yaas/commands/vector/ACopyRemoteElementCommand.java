...
public class ACopyRemoteElementCommand<ElementType> implements Command{
	...
	public ACopyRemoteElementCommand(ListenableVector<ElementType> buf, int aFromPosition, ListenableVector<ElementType> aRemoteBuffer, int pos) {
		buffer = buf;
		toPosition = pos;
	...
	public Object execute() {
		...
		buffer.copy(fromPosition, remoteBuffer, toPosition);
		return null;
	}
	public void undo() {
		oldVal = remoteBuffer.set(toPosition, oldVal);
	}
