...
public class ACompositeShapeListAngleIncrementer extends AnAbstractRangeBasedCompositeObjectIncrementer<Rotatable, Double> 
	implements RangeBasedObjectIncrementer<List<? extends Rotatable>, List<Double>> {

	public void init(List<? extends Rotatable> anObjects, List<Double> aFinalValues) {
		List<RangeBasedObjectIncrementer<Rotatable, Double>> anIncrementers = new ArrayList();
		for (int i = 0; i < anObjects.size(); i++) {
			anIncrementers.add(new ARangeBasedShapeAngleIncrementer());
		}
