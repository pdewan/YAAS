...
public class ACompositeCartesianShapeListDimensionIncrementer 
	extends AnAbstractRangeBasedCompositeObjectIncrementer<BoundedShape, Dimension> 
	...
	public void init(List<? extends BoundedShape> anObjects, List<Dimension> aFinalValues) {
		...
		for (int i = 0; i < anObjects.size(); i++) {
			anIncrementers.add(new ACartesianShapeDimensionIncrementer());
		}
